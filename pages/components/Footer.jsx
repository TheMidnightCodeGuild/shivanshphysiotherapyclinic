...
const Footer = () => {
  return (
    <>
      ...
      <footer className="text-white border-t-2 border-black bg-amber-800   py-10 sm:py-10 flex justify-center items-center  bottom-0 left-0 right-0">
