    ...
    <section className="text-gray-600 body-font relative min-h-screen py-8 sm:py-5 md:py-16 lg:py-20">
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12  justify-center items-center ">
          {/* Map Section */}
          <div className="w-full lg:w-1/2 h-[400px] sm:h-[450px] md:h-[500px] relative bg-white rounded-lg overflow-hidden border-2 border-orange-500">
            <iframe
              width="100%"
              height="100%"
          ...
          <div className="w-full lg:w-1/2 -mt-10">
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-500 text-white py-2 px-4 rounded-md hover:bg-orange-600 transition duration-300 flex items-center justify-center min-h-[44px]"
