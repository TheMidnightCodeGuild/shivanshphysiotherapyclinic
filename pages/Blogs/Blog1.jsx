    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">
          Why Choose Shivansh Physiotherapy Clinic for Your Rehabilitation Needs
        </h1>
        ...
        <div className="prose prose-lg">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">
            Why Physiotherapy at Shivansh Physiotherapy Clinic?
          </h2>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-4">
            ...
            <li>
              ...
              including manual therapy, exercise therapy, post-surgical rehabilitation, pain management, and more.
            </li>
            <li>
              <strong>Convenient Location in Ujjain:</strong> Our clinic in Swami Vivekanand Colony, Ujjain is 
              easily accessible, making it simple for you to receive the physiotherapy treatment you need without hassle.
            </li>
          </ul>

          <p className="mt-6">
            If you want to experience exceptional physiotherapy care, contact Shivansh Physiotherapy Clinic today 
            and schedule an appointment with Doctor Naveen Moghi. We are here to help you move better and feel better.
          </p>
        </div>
      </div>
    </div>
